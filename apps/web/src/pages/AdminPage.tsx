...
const COLLECTIONS: FormCollectionConfig[] = [
  ...
  },
  {
    ...
    fields: [
      { key: 'employee',   label: 'Employee ID',  type: 'text',     required: true },
  ...
  },
  {
    ...
    columns: [
      ...
      { key: 'max_days_per_year',    label: 'Max Days/Year' },
      { key: 'notice_days_required', label: 'Min Notice (days)' },
      { key: 'status',               label: 'Status', render: (v) => statusBadge(String(v ?? '')) },
    ],
    fields: [
      { key: 'name',                 label: 'Policy Name',         type: 'text',  required: true },
      { key: 'leave_type',           label: 'Leave Type',          type: 'text',  required: true },
      { key: 'max_days_per_year',    label: 'Max Days Per Year',   type: 'text',  required: true },
      { key: 'notice_days_required', label: 'Min Days Notice',     type: 'text' },
